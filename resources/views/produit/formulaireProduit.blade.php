                ...
                <div class="p-6 text-gray-900 space-y-4">
                    <form method="post" action="{{ route('enregistrementProduit',['id' => $produit->id_produit]) }}" class="border-solid border-2 border-gray-500 rounded-xl w-4/5 m-auto" id="formProduit">
                        ...
                        <div class="full-width flex border justify-self-end">
                            <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded self-end">Modifier</button>
                        </div>
                    </form>
                    @if ($errors->any())
                        <div class="border border-red-400 rounded bg-red-100 px-4 py-3 text-red-700 w-4/5 m-auto">
